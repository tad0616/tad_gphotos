    ...
    <{if $tad_gphotos_adm or $create_album}>
        <div class="text-right text-end">
            <{if $smarty.get.csn|default:false}>
                <a href="<{$xoops_url}>/modules/tad_gphotos/admin/main.php?op=tad_gphotos_add_cate_form&csn=<{$smarty.get.csn|intval}>" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i> <{$smarty.const._MD_TADGPHOTOS_CATE_FORM}></a>
            <{/if}>
