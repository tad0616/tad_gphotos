        ...
        <div id="GP_begin<{$block.album_sn}>">
            <ul style="list-style: none;">
                <{foreach from=$block.content item=data}>
                    <li>
                        <a href="<{$data.image_link}>" data-photo="<{$data.image_link}>" data-sn="<{$data.image_sn}>" target="_blank">
                            <img src="<{$data.image_url}>" alt="<{if $data.image_description}><{$data.image_description}><{else}><{$block.album_name}><{/if}>" title="<{if $data.image_description}><{$data.image_description}><{else}><{$block.album_name}><{/if}>">
                        </a>
                    </li>
                <{/foreach}>
            </ul>
