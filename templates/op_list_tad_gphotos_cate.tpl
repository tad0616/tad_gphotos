                    ...
                    <tbody id="sort">
                        <{foreach from=$gphotos item=album}>
                            <tr id="album_sn_<{$album.album_sn}>">
                                ...
                                <td class="c">
                                    <a href="javascript:delete_tad_gphotos_func(<{$album.album_sn}>);" class="btn btn-sm btn-xs btn-danger" id="del<{$album.album_sn}>"><i class="fa fa-trash" aria-hidden="true"></i> <{$smarty.const._TAD_DEL}></a>
                                    <a href="<{$xoops_url}>/modules/tad_gphotos/index.php?op=tad_gphotos_form&album_sn=<{$album.album_sn}>" class="btn btn-sm btn-xs btn-info" id="update<{$album.album_sn}>"><i class="fa fa-pencil" aria-hidden="true"></i> <{$smarty.const._TAD_EDIT}></a>
                                </td>
                            </tr>
                        <{/foreach}>
                    </tbody>
